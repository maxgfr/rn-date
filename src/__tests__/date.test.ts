...
describe('RnDate', () => {
  describe('Date without hour, minutes, seconds', () => {
    it('should work with no parameters', () => {
      expect(new RnDate().toDateString()).toEqual(new Date().toDateString());
    });

    it('should not work with empty parameters', () => {
      expect(new RnDate('').toDateString()).toEqual(
  ...
  describe('Date without hour, minutes, seconds', () => {
    ...
    it('should work with to iso string', () => {
      expect(new RnDate('2022-01-01').toISOString()).toBe(
        new Date('2022-01-01').toISOString(),
      );
    });

    it('should work with to date string', () => {
      expect(new RnDate('2022-01-01').toDateString()).toBe(
        new Date('2022-01-01').toDateString(),
      );
    });

    it('should work with getTime ', () => {
      expect(new RnDate('2022-01-01').getTime()).toEqual(
  ...
  describe('Date with hour, minutes, seconds', () => {
    ...
    it('should work equal as date', () => {
      expect(new RnDate('2022-01-01 17:04:03')).toEqual(
        new Date('2022-01-01 17:04:03'),
      );
    });

    it('should work with to iso string', () => {
      expect(new RnDate('2022-01-01 17:04:03').toISOString()).toBe(
        new Date('2022-01-01 17:04:03').toISOString(),
      );
    });

    it('should work with to date string', () => {
      expect(new RnDate('2022-01-01 17:04:03').toDateString()).toBe(
        new Date('2022-01-01 17:04:03').toDateString(),
      );
    });

    it('should work with getTime ', () => {
      expect(new RnDate('2022-01-01 17:04:03').getTime()).toEqual(
        new Date('2022-01-01 17:04:03').getTime(),
      );
    });
  });
});
